...
const { getTodoList, getImportantTodoList, getDatedTodoList, findTodoFromUser } = require('./todoUtils');
const { compareByDate, compareByImportance, compareByUser } = require('./comparing');
...
function app () {
    ...
    const readLineCb = command =>
        processCommand(command, todoList);
